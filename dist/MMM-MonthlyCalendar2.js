(function () {
	...
	//#region packages/@mantine/core/src/core/utils/keys/keys.ts
	...
	//#region packages/@mantine/core/src/core/utils/is-element/is-element.ts
	function isElement$1(value) {
		if (Array.isArray(value) || value === null) return false;
		if (typeof value === "object") {
			if (value.type === reactExports.Fragment) return false;
			return true;
		}
		return false;
	}
	...
	//#region packages/@mantine/core/src/core/utils/noop/noop.ts
	const noop$2 = () => {};
	...
	function useDebouncedCallback(callback, options) {
		...
		const maxWaitTimerRef = reactExports.useRef(0);
		const latestArgsRef = reactExports.useRef(null);
	...
	function useClickOutside(callback, events, nodes, enabled = true) {
		...
		const listener = reactExports.useEffectEvent((event) => {
			const { target } = event ?? {};
	...
	function useMediaQuery(query, initialValue, { getInitialValueInEffect } = { getInitialValueInEffect: true }) {
		const [matches, setMatches] = reactExports.useState(getInitialValueInEffect ? initialValue : getInitialValue(query));
		reactExports.useEffect(() => {
			try {
	...
	function useId$1(staticId) {
		const [uuid, setUuid] = reactExports.useState(`mantine-${reactExports.useId().replace(/:/g, "")}`);
		useIsomorphicEffect(() => {
			setUuid(randomId());
		}, []);
	...
	function useWindowEvent(type, listener, options) {
		const stableListener = reactExports.useEffectEvent(listener);
		reactExports.useEffect(() => {
	...
	function mergeRefs(...refs) {
		...
		return (node) => {
			refs.forEach((ref) => {
				const cleanup = assignRef$1(ref, node);
	...
	function useUncontrolled({ value, defaultValue, finalValue, onChange = () => {} }) {
		const [uncontrolledValue, setUncontrolledValue] = reactExports.useState(defaultValue !== void 0 ? defaultValue : finalValue);
	...
	//#region packages/@mantine/core/src/core/utils/get-single-element-child/get-single-element-child.ts
	...
	//#region packages/@mantine/core/src/core/styles-api/create-vars-resolver/create-vars-resolver.ts
	...
	//#region packages/@mantine/core/src/core/MantineProvider/color-scheme-managers/is-mantine-color-scheme.ts
	...
	//#region packages/@mantine/core/src/core/MantineProvider/color-functions/get-theme-color/get-theme-color.ts
	...
	//#region packages/@mantine/core/src/core/MantineProvider/color-functions/darken/darken.ts
	...
	//#region packages/@mantine/core/src/core/MantineProvider/color-functions/rgba/rgba.ts
	...
	function useMantineContext() {
		const ctx = reactExports.use(MantineContext);
	...
	function useProviderColorScheme({ manager, defaultColorScheme, getRootElement, forceColorScheme }) {
		...
		const setColorScheme = reactExports.useCallback((colorScheme) => {
			if (!forceColorScheme) {
	...
	const useSafeMantineTheme = () => reactExports.use(MantineThemeContext) || DEFAULT_THEME;
	function useMantineTheme() {
		const ctx = reactExports.use(MantineThemeContext);
	...
	function MantineThemeProvider({ theme, children, inherit = true }) {
		...
		return /* @__PURE__ */ jsxRuntimeExports.jsx(MantineThemeContext, {
			value: reactExports.useMemo(() => mergeMantineTheme(inherit ? parentTheme : DEFAULT_THEME, theme), [
				theme,
				parentTheme,
				inherit
			]),
	...
	//#region packages/@mantine/core/src/core/MantineProvider/convert-css-variables/css-variables-object-to-string.ts
	...
	//#region packages/@mantine/core/src/core/MantineProvider/MantineCssVariables/get-css-color-variables.ts
	...
	//#region packages/@mantine/core/src/core/MantineProvider/MantineClasses/MantineClasses.tsx
	...
	//#region packages/@mantine/core/src/core/MantineProvider/MantineCssVariables/get-merged-variables.ts
	...
	function MantineCssVariables({ cssVariablesSelector, deduplicateCssVariables }) {
		...
		if (css) return /* @__PURE__ */ jsxRuntimeExports.jsx("style", {
	...
	//#region packages/@mantine/core/src/core/MantineProvider/use-respect-reduce-motion/use-respect-reduce-motion.ts
	...
	function MantineProvider({ theme, children, getStyleNonce, withStaticClasses = true, withGlobalClasses = true, deduplicateCssVariables = true, withCssVariables = true, cssVariablesSelector, classNamesPrefix = "mantine", colorSchemeManager = localStorageColorSchemeManager(), defaultColorScheme = "light", getRootElement = () => document.documentElement, cssVariablesResolver, forceColorScheme, stylesTransform, env, deduplicateInlineStyles = false }) {
		...
		return /* @__PURE__ */ jsxRuntimeExports.jsx(MantineContext, {
			value: {
				colorScheme,
				setColorScheme,
				clearColorScheme,
			...
			children: /* @__PURE__ */ jsxRuntimeExports.jsxs(MantineThemeProvider, {
				theme,
				children: [
					withCssVariables && /* @__PURE__ */ jsxRuntimeExports.jsx(MantineCssVariables, {
	...
	//#region packages/@mantine/core/src/core/MantineProvider/create-theme/create-theme.ts
	...
	//#region packages/@mantine/core/src/core/styles-api/use-styles/get-class-name/get-options-class-names/get-options-class-names.ts
	...
	//#region packages/@mantine/core/src/core/styles-api/use-styles/get-class-name/get-resolved-class-names/get-resolved-class-names.ts
	...
	//#region packages/@mantine/core/src/core/styles-api/use-styles/get-style/resolve-vars/merge-vars.ts
	...
	//#region packages/@mantine/core/src/core/InlineStyles/css-object-to-string/css-object-to-string.ts
	...
	function InlineStyles({ deduplicate, ...props }) {
		...
		if (deduplicate) return /* @__PURE__ */ jsxRuntimeExports.jsx("style", {
	...
	//#region packages/@mantine/core/src/core/Box/style-props/resolvers/color-resolver/color-resolver.ts
	...
	//#region packages/@mantine/core/src/core/Box/style-props/resolvers/border-resolver/border-resolver.ts
	...
	//#region packages/@mantine/core/src/core/Box/style-props/resolvers/identity-resolver/identity-resolver.ts
	...
	//#region packages/@mantine/core/src/core/Box/style-props/resolvers/radius-resolver/radius-resolver.ts
	...
	//#region packages/@mantine/core/src/core/Box/style-props/resolvers/size-resolver/size-resolver.ts
	...
	//#region packages/@mantine/core/src/core/Box/style-props/parse-style-props/sort-media-queries.ts
	...
	//#region packages/@mantine/core/src/core/Box/use-random-classname/use-random-classname.ts
	function useRandomClassName() {
		return `__m__-${reactExports.useId().replace(/[:«»]/g, "")}`;
	}

	//#region packages/@mantine/core/src/core/factory/create-polymorphic-component.ts
	...
	function factory(ui) {
		const Component = ui;
		Component.extend = identity$1;
		Component.withProps = (fixedProps) => {
			const Extended = (props) => /* @__PURE__ */ jsxRuntimeExports.jsx(Component, {
				...fixedProps,
				...props
			});
	...
	function _Box({ component, style, __vars, className, variant, mod, size, hiddenFrom, visibleFrom, lightHidden, darkHidden, renderRoot, __size, ref, ...others }) {
		...
		return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [parsedStyleProps.hasResponsiveStyles && /* @__PURE__ */ jsxRuntimeExports.jsx(InlineStyles, {
	...
	function useDirection() {
		return reactExports.use(DirectionContext);
	}

	//#region packages/@mantine/core/src/components/ScrollArea/ScrollArea.context.ts
	...
	function useResizeObserver(element, onResize) {
		const handleResize = reactExports.useEffectEvent(onResize);
		useIsomorphicEffect(() => {
			let rAF = 0;
			if (element) {
	...
	function Corner(props) {
		...
		return hasSize ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
			...others,
			style: {
				...style,
				width,
	...
	function ScrollAreaCorner(props) {
		...
		return ctx.type !== "scroll" && hasBothScrollbarsVisible ? /* @__PURE__ */ jsxRuntimeExports.jsx(Corner, { ...props }) : null;
	}
	...
	function ScrollAreaRoot(_props) {
		...
		return /* @__PURE__ */ jsxRuntimeExports.jsx(ScrollAreaProvider, {
			value: {
				type,
				scrollHideDelay,
				scrollArea,
	...
	//#region packages/@mantine/core/src/components/ScrollArea/utils/get-thumb-ratio.tsx
	...
	//#region packages/@mantine/core/src/components/ScrollArea/utils/is-scrolling-within-scrollbar-bounds.ts
	function isScrollingWithinScrollbarBounds(scrollPos, maxScrollPos) {
		return scrollPos > 0 && scrollPos < maxScrollPos;
	}

	//#region packages/@mantine/core/src/components/ScrollArea/utils/to-int.ts
	...
	//#region packages/@mantine/core/src/components/ScrollArea/ScrollAreaScrollbar/Scrollbar.context.ts
	...
	function Scrollbar(props) {
		...
		const maxScrollPos = sizes.content - sizes.viewport;
		const handleWheelScroll = reactExports.useEffectEvent(onWheelScroll);
		...
		return /* @__PURE__ */ jsxRuntimeExports.jsx(ScrollbarProvider, {
			value: {
				scrollbar,
				hasThumb,
	...
	const ScrollAreaScrollbarX = (props) => {
		...
		return /* @__PURE__ */ jsxRuntimeExports.jsx(Scrollbar, {
	...
	function ScrollAreaScrollbarVisible(props) {
		...
		if (orientation === "horizontal") return /* @__PURE__ */ jsxRuntimeExports.jsx(ScrollAreaScrollbarX, {
			...commonProps,
		...
		if (orientation === "vertical") return /* @__PURE__ */ jsxRuntimeExports.jsx(ScrollAreaScrollbarY, {
			...commonProps,
			onThumbPositionChange: () => {
				if (context.viewport && thumbRef.current) {
	...
	function ScrollAreaScrollbarAuto(props) {
		...
		useResizeObserver(context.content, handleResize);
		if (forceMount || visible) return /* @__PURE__ */ jsxRuntimeExports.jsx(ScrollAreaScrollbarVisible, {
	...
	function ScrollAreaScrollbarHover(props) {
		...
		if (forceMount || visible) return /* @__PURE__ */ jsxRuntimeExports.jsx(ScrollAreaScrollbarAuto, {
			"data-state": visible ? "visible" : "hidden",
			...scrollbarProps
		});
		return null;
	...
	function ScrollAreaScrollbarScroll(props) {
		...
		if (forceMount || state !== "hidden") return /* @__PURE__ */ jsxRuntimeExports.jsx(ScrollAreaScrollbarVisible, {
	...
	function ScrollAreaScrollbar(props) {
		...
		return context.type === "hover" ? /* @__PURE__ */ jsxRuntimeExports.jsx(ScrollAreaScrollbarHover, {
			...scrollbarProps,
			forceMount
		}) : context.type === "scroll" ? /* @__PURE__ */ jsxRuntimeExports.jsx(ScrollAreaScrollbarScroll, {
			...scrollbarProps,
			forceMount
		}) : context.type === "auto" ? /* @__PURE__ */ jsxRuntimeExports.jsx(ScrollAreaScrollbarAuto, {
			...scrollbarProps,
			forceMount
		}) : context.type === "always" ? /* @__PURE__ */ jsxRuntimeExports.jsx(ScrollAreaScrollbarVisible, { ...scrollbarProps }) : null;
	}
	...
	function ScrollAreaThumb(props) {
		...
		const scrollbarContext = useScrollbarContext();
		if (forceMount || scrollbarContext.hasThumb) return /* @__PURE__ */ jsxRuntimeExports.jsx(Thumb, { ...thumbProps });
		return null;
	}
	...
	//#region packages/@mantine/core/src/components/ScrollArea/ScrollArea.module.css
	...
	const ScrollArea = factory((_props) => {
		...
		const prevAtTopRef = reactExports.useRef(true);
		const prevAtBottomRef = reactExports.useRef(false);
		const prevAtLeftRef = reactExports.useRef(true);
		const prevAtRightRef = reactExports.useRef(false);
		...
		return /* @__PURE__ */ jsxRuntimeExports.jsxs(ScrollAreaRoot, {
			...
			children: [
				...
				(scrollbars === "xy" || scrollbars === "x") && /* @__PURE__ */ jsxRuntimeExports.jsx(ScrollAreaScrollbar, {
					...getStyles("scrollbar"),
				...
				(scrollbars === "xy" || scrollbars === "y") && /* @__PURE__ */ jsxRuntimeExports.jsx(ScrollAreaScrollbar, {
					...getStyles("scrollbar"),
	...
	const ScrollAreaAutosize = factory((props) => {
		...
		const handleOverflowCheck = reactExports.useEffectEvent(() => {
	...
	//#region packages/@mantine/core/src/components/UnstyledButton/UnstyledButton.module.css
	...
	//#region packages/@mantine/core/src/components/VisuallyHidden/VisuallyHidden.module.css
	var VisuallyHidden_module_default = { "root": "m_515a97f8" };

	//#region packages/@mantine/core/src/components/VisuallyHidden/VisuallyHidden.tsx
	const VisuallyHidden = factory((_props) => {
	...
	//#region packages/@mantine/core/src/components/Paper/Paper.module.css
	...
	const Paper = polymorphicFactory((_props) => {
	...
	//#region packages/@mantine/core/src/components/Overlay/Overlay.module.css
	...
	const OptionalPortal = factory(({ withinPortal = true, children, ...others }) => {
		if (useMantineEnv() === "test" || !withinPortal) return /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children });
	...
	function Transition({ keepMounted, transition = "fade", duration = 250, exitDuration = duration, mounted, children, timingFunction = "ease", onExit, onEntered, onEnter, onExited, enterDelay, exitDelay }) {
		...
		if (env === "test") return mounted ? /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: children({}) }) : keepMounted ? children({ display: "none" }) : null;
		if (transitionDuration === 0) {
			if (keepMounted) return /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Activity, {
				mode: mounted ? "visible" : "hidden",
				children: children({})
			});
			return mounted ? /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: children({}) }) : null;
		}
		...
		return isExited ? null : /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: children(getTransitionStyles({
			transition,
			duration: transitionDuration,
			state: transitionStatus,
			timingFunction: transitionTimingFunction
	...
	//#region packages/@mantine/core/src/components/Popover/Popover.context.ts
	...
	const PopoverDropdown = factory((_props) => {
		...
		return /* @__PURE__ */ jsxRuntimeExports.jsx(OptionalPortal, {
			...ctx.portalProps,
			...
			children: /* @__PURE__ */ jsxRuntimeExports.jsx(Transition, {
				...
				children: (transitionStyles) => /* @__PURE__ */ jsxRuntimeExports.jsx(FocusTrap, {
					...
					children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, {
						...
						children: [children, /* @__PURE__ */ jsxRuntimeExports.jsx(FloatingArrow, {
							ref: ctx.arrowRef,
							arrowX: ctx.arrowX,
							arrowY: ctx.arrowY,
	...
	function Popover(_props) {
		...
		const reference = reactExports.useCallback((node) => {
			setTargetNode(node);
			popover.floating.refs.setReference(node);
		}, [popover.floating.refs.setReference]);
		const floating = reactExports.useCallback((node) => {
		...
		return /* @__PURE__ */ jsxRuntimeExports.jsxs(PopoverContextProvider, {
			value: {
				returnFocus,
				disabled,
			...
			children: [children, withOverlay && /* @__PURE__ */ jsxRuntimeExports.jsx(Transition, {
				transition: "fade",
				mounted: popover.opened,
				duration: transitionProps?.duration || 250,
				exitDuration: transitionProps?.exitDuration || 250,
				children: (transitionStyles) => /* @__PURE__ */ jsxRuntimeExports.jsx(OptionalPortal, {
					withinPortal,
	...
	Popover.withProps = (fixedProps) => {
		const Extended = (props) => /* @__PURE__ */ jsxRuntimeExports.jsx(Popover, {
			...fixedProps,
			...props
		});
	...
	//#region packages/@mantine/core/src/components/Loader/loaders/Bars.tsx
	const Bars = ({ className, ...others }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, {
		component: "span",
		className: clsx(Loader_module_default.barsLoader, className),
		...others,
		children: [
			/* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: Loader_module_default.bar }),
			/* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: Loader_module_default.bar }),
			/* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: Loader_module_default.bar })
		]
	});
	...
	//#region packages/@mantine/core/src/components/Loader/loaders/Dots.tsx
	const Dots = ({ className, ...others }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, {
		component: "span",
		className: clsx(Loader_module_default.dotsLoader, className),
		...others,
		children: [
			/* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: Loader_module_default.dot }),
			/* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: Loader_module_default.dot }),
			/* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: Loader_module_default.dot })
		]
	});
	...
	const Oval = ({ className, ...others }) => /* @__PURE__ */ jsxRuntimeExports.jsx(Box, {
		component: "span",
	...
	//#region packages/@mantine/core/src/components/CloseButton/CloseButton.module.css
	...
	const CloseButton = polymorphicFactory((_props) => {
		...
		return /* @__PURE__ */ jsxRuntimeExports.jsxs(UnstyledButton, {
			...
			children: [icon || /* @__PURE__ */ jsxRuntimeExports.jsx(CloseIcon, {}), children]
		});
	});
	...
	***************************************************************************** */
	...
	function ModalBase({ keepMounted, opened, onClose, id, transitionProps, onExitTransitionEnd, onEnterTransitionEnd, trapFocus, closeOnEscape, returnFocus, closeOnClickOutside, withinPortal, portalProps, lockScroll, children, zIndex, shadow, padding, __vars, unstyled, removeScrollProps, ...others }) {
		...
		return /* @__PURE__ */ jsxRuntimeExports.jsx(OptionalPortal, {
			...portalProps,
			withinPortal,
			children: /* @__PURE__ */ jsxRuntimeExports.jsx(ModalBaseProvider, {
				value: {
					opened,
					onClose,
					closeOnClickOutside,
	...
	//#region packages/@mantine/core/src/components/ModalBase/use-modal-body-id.ts
	...
	//#region packages/@mantine/core/src/components/ModalBase/ModalBase.module.css
	...
	//#region packages/@mantine/core/src/components/ModalBase/ModalBaseBody.tsx
	...
	function ModalBaseCloseButton({ className, onClick, ...others }) {
		const ctx = useModalBaseContext();
		return /* @__PURE__ */ jsxRuntimeExports.jsx(CloseButton, {
			...others,
			onClick: (event) => {
				ctx.onClose();
				onClick?.(event);
	...
	function ModalBaseContent({ transitionProps, className, innerProps, onKeyDown, style, ref, ...others }) {
		...
		return /* @__PURE__ */ jsxRuntimeExports.jsx(Transition, {
			...
			...transitionProps,
			children: (transitionStyles) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
				...innerProps,
	...
	//#region packages/@mantine/core/src/components/ModalBase/ModalBaseHeader.tsx
	...
	//#region packages/@mantine/core/src/components/ModalBase/use-modal-transition.ts
	...
	function ModalBaseOverlay({ onClick, transitionProps, style, visible, ...others }) {
		...
		return /* @__PURE__ */ jsxRuntimeExports.jsx(Transition, {
			...
			...transition,
			transition: "fade",
			children: (transitionStyles) => /* @__PURE__ */ jsxRuntimeExports.jsx(Overlay, {
				fixed: true,
				style: [style, transitionStyles],
				zIndex: ctx.zIndex,
				unstyled: ctx.unstyled,
	...
	//#region packages/@mantine/core/src/components/ModalBase/use-modal-title-id.ts
	...
	//#region packages/@mantine/core/src/components/ModalBase/ModalBaseTitle.tsx
	...
	//#region packages/@mantine/core/src/components/ModalBase/NativeScrollArea.tsx
	function NativeScrollArea({ children }) {
		return /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children });
	}

	//#region packages/@mantine/core/src/components/Input/Input.context.ts
	const InputContext = reactExports.createContext({ size: "sm" });
	...
	const InputClearButton = factory((_props) => {
		...
		const ctx = reactExports.use(InputContext);
	...
	function InputClearSection({ __clearable, __clearSection, rightSection, __defaultRightSection, size = "sm", __clearSectionMode = "both" }) {
		...
		if (clearSection && (rightSection || __defaultRightSection)) return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
	...
	const InputLabel = factory((_props) => {
		...
		return /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, {
			...
			...others,
			children: [children, required && /* @__PURE__ */ jsxRuntimeExports.jsx("span", {
				...getStyles("required"),
				"aria-hidden": true,
				children: " *"
			})]
	...
	const InputPlaceholder = factory((_props) => {
	...
	const InputWrapper = factory((_props) => {
		...
		const _label = label && /* @__PURE__ */ jsxRuntimeExports.jsx(InputLabel, {
			labelElement,
			id: labelId,
			htmlFor: inputId,
			required: isRequired,
		...
		const _description = hasDescription && /* @__PURE__ */ jsxRuntimeExports.jsx(InputDescription, {
			...descriptionProps,
			...sharedProps,
		...
		const _error = hasError && /* @__PURE__ */ reactExports.createElement(InputError, {
			...errorProps,
			...sharedProps,
		...
		return /* @__PURE__ */ jsxRuntimeExports.jsx(InputWrapperContext, {
			value: {
				getStyles,
				describedBy,
				inputId,
	...
	const Input = polymorphicFactory((_props) => {
		...
		const loadingIndicator = loading ? /* @__PURE__ */ jsxRuntimeExports.jsx(Loader, { size: loadingPosition === "left" ? "calc(var(--input-left-section-size) / 2)" : "calc(var(--input-right-section-size) / 2)" }) : null;
		...
		return /* @__PURE__ */ jsxRuntimeExports.jsx(InputContext, {
			value: { size: size || "sm" },
			children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, {
				ref: rootRef,
				...getStyles("wrapper"),
				...
				size,
				children: [
					_leftSection && /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
						...leftSectionProps,
						"data-position": "left",
						...getStyles("section", {
					...
					_rightSection && /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
						...rightSectionProps,
						"data-position": "right",
						...getStyles("section", {
	...
	//#region packages/@mantine/core/src/components/Modal/ModalBody.tsx
	const ModalBody = factory((_props) => {
		const { classNames, className, style, styles, vars, ...others } = useProps("ModalBody", null, _props);
		return /* @__PURE__ */ jsxRuntimeExports.jsx(ModalBaseBody, {
	...
	//#region packages/@mantine/core/src/components/Modal/ModalCloseButton.tsx
	const ModalCloseButton = factory((_props) => {
		const { classNames, className, style, styles, vars, ...others } = useProps("ModalCloseButton", null, _props);
		return /* @__PURE__ */ jsxRuntimeExports.jsx(ModalBaseCloseButton, {
	...
	const ModalContent = factory((_props) => {
		...
		return /* @__PURE__ */ jsxRuntimeExports.jsx(ModalBaseContent, {
			...ctx.getStyles("content", {
				className,
				style,
				styles,
			...
			...others,
			children: /* @__PURE__ */ jsxRuntimeExports.jsx(Scroll, {
	...
	//#region packages/@mantine/core/src/components/Modal/ModalHeader.tsx
	const ModalHeader = factory((_props) => {
		const { classNames, className, style, styles, vars, ...others } = useProps("ModalHeader", null, _props);
		return /* @__PURE__ */ jsxRuntimeExports.jsx(ModalBaseHeader, {
	...
	//#region packages/@mantine/core/src/components/Modal/ModalOverlay.tsx
	const ModalOverlay = factory((_props) => {
		const { classNames, className, style, styles, vars, ...others } = useProps("ModalOverlay", null, _props);
		return /* @__PURE__ */ jsxRuntimeExports.jsx(ModalBaseOverlay, {
	...
	const ModalRoot = factory((_props) => {
		...
		return /* @__PURE__ */ jsxRuntimeExports.jsx(ModalProvider, {
			...
			children: /* @__PURE__ */ jsxRuntimeExports.jsx(ModalBase, {
				...getStyles("root"),
	...
	const ModalStackContext = reactExports.createContext(null);
	function ModalStack({ children }) {
		...
		return /* @__PURE__ */ jsxRuntimeExports.jsx(ModalStackContext, {
			value: {
				stack,
				addModal: (id, zIndex) => {
	...
	//#region packages/@mantine/core/src/components/Modal/ModalTitle.tsx
	const ModalTitle = factory((_props) => {
		const { classNames, className, style, styles, vars, ...others } = useProps("ModalTitle", null, _props);
		return /* @__PURE__ */ jsxRuntimeExports.jsx(ModalBaseTitle, {
	...
	const Modal = factory((_props) => {
		...
		return /* @__PURE__ */ jsxRuntimeExports.jsxs(ModalRoot, {
			radius,
			opened,
			zIndex: ctx && stackId ? ctx.getZIndex(stackId) : zIndex,
			...others,
			...stackProps,
			children: [withOverlay && /* @__PURE__ */ jsxRuntimeExports.jsx(ModalOverlay, {
				...
				children: [hasHeader && /* @__PURE__ */ jsxRuntimeExports.jsxs(ModalHeader, { children: [title && /* @__PURE__ */ jsxRuntimeExports.jsx(ModalTitle, { children: title }), withCloseButton && /* @__PURE__ */ jsxRuntimeExports.jsx(ModalCloseButton, { ...closeButtonProps })] }), /* @__PURE__ */ jsxRuntimeExports.jsx(ModalBody, { children })]
			})]
		});
	});
	...
	const NativeSelect = factory((props) => {
		...
		return /* @__PURE__ */ jsxRuntimeExports.jsx(InputBase, {
			...
			error,
			unstyled,
			rightSection: rightSection || /* @__PURE__ */ jsxRuntimeExports.jsx(ComboboxChevron, {
				size,
				error,
				unstyled
			}),
	...
	const DEFAULT_SCHEDULE_LABELS = {
		...
		noEvents: "No events",
		moreLabel: (hiddenEventsCount) => `+${hiddenEventsCount} more`
	};
	function getLabel(key, override) {
		if (override) return {
	...
	//#region packages/@mantine/schedule/src/utils/format-date/format-date.ts
	function formatDate({ locale, date, format }) {
		if (typeof format === "function") return format(dayjs(date).format("YYYY-MM-DD HH:mm:ss"));
		return dayjs(date).locale(locale).format(format);
	}

	//#region packages/@mantine/schedule/src/utils/get-weekdays-names/get-weekdays-names.ts
	function getWeekdaysNames({ locale, format = "dd", firstDayOfWeek = 1 }) {
		const baseDate = dayjs().day(firstDayOfWeek);
		const labels = [];
		for (let i = 0; i < 7; i += 1) labels.push(formatDate({
			locale,
			date: baseDate.add(i, "days"),
			format
		}));
		return labels;
	}

	//#region packages/@mantine/schedule/src/utils/get-start-of-week/get-start-of-week.ts
	...
	//#region packages/@mantine/schedule/src/utils/get-end-of-week/get-end-of-week.ts
	...
	//#region packages/@mantine/schedule/src/utils/get-week-number/get-week-number.ts
	dayjs.extend(isoWeek);
	function getWeekNumber(week) {
		if (Array.isArray(week)) return dayjs(week.find((date) => dayjs(date).day() === 1)).isoWeek();
		return dayjs(week).isoWeek();
	}

	//#region packages/@mantine/schedule/src/utils/get-month-days/get-month-days.ts
	function getMonthDays$1({ month, firstDayOfWeek = 1, consistentWeeks }) {
		const start = dayjs(dayjs(month).subtract(dayjs(month).date() - 1, "day").format("YYYY-MM-DD"));
	...
	//#region packages/@mantine/schedule/src/utils/is-same-month/is-same-month.ts
	function isSameMonth(date, comparison) {
		return dayjs(date).format("YYYY-MM") === dayjs(comparison).format("YYYY-MM");
	}

	//#region packages/@mantine/schedule/src/utils/to-date-string/to-date-string.ts
	function toDateString(date) {
		return dayjs(date).format("YYYY-MM-DD 00:00:00");
	}

	//#region packages/@mantine/schedule/src/utils/get-months-list/get-months-list.ts
	function getMonthsList({ locale, format }) {
		const months = [];
		const date = dayjs().locale(locale).startOf("year");
		for (let i = 0; i < 12; i++) months.push({
			month: i,
			name: formatDate({
				date: date.add(i, "month"),
				format,
				locale
			})
		});
	...
	//#region packages/@mantine/schedule/src/utils/get-years-list/get-years-list.ts
	function getYearsList({ startYear, endYear }) {
		const years = [];
		for (let year = startYear; year <= endYear; year++) years.push(year);
		return years;
	}

	//#region packages/@mantine/schedule/src/utils/validate-event/validate-event.ts
	function validateEvent(eventData) {
		if (!dayjs(eventData.start).isValid()) throw new Error(`[@mantine/schedule] Invalid start date for event id: ${eventData.id}`);
		if (!dayjs(eventData.end).isValid()) throw new Error(`[@mantine/schedule] Invalid end date for event id: ${eventData.id}`);
		if (dayjs(eventData.end).isBefore(dayjs(eventData.start))) throw new Error(`[@mantine/schedule] Event end date is before start date for event id: ${eventData.id}`);
		return eventData;
	}

	//#region packages/@mantine/schedule/src/utils/get-month-range/get-month-range.ts
	/** Returns start and end dates as displayed in MonthView */
	function getMonthRange({ month, withOutsideDays, consistentWeeks, firstDayOfWeek }) {
		if (!withOutsideDays) return {
			start: toDateString(dayjs(month).startOf("month")),
			end: toDateString(dayjs(month).endOf("month"))
		};
		const days = getMonthDays$1({
			month,
			firstDayOfWeek,
			consistentWeeks
		});
	...
	//#region packages/@mantine/schedule/src/utils/calculate-month-drop-date/calculate-month-drop-date.ts
	function calculateMonthDropDate({ draggedEvent, targetDay }) {
		...
		const newStart = dayjs(targetDay).startOf("day").hour(originalStartTime.hour()).minute(originalStartTime.minute()).second(originalStartTime.second()).millisecond(originalStartTime.millisecond());
	...
	function parseOptions(options) {
	  ...
	  if (isPresent(opts.byeaster)) opts.freq = RRule$1.YEARLY;
	  ...
	  if (!isPresent(opts.byminute)) {
	    opts.byminute = opts.freq < RRule$1.MINUTELY ? [opts.dtstart.getUTCMinutes()] : null;
	  } else if (isNumber(opts.byminute)) {
	    opts.byminute = [opts.byminute];
	  }
	  // bysecond
	  if (!isPresent(opts.bysecond)) {
	    opts.bysecond = opts.freq < RRule$1.SECONDLY ? [opts.dtstart.getUTCSeconds()] : null;
	...
	function makeTimeset(ii, counterDate, options) {
	  ...
	  if (freq >= RRule$1.HOURLY && notEmpty(byhour) && !includes(byhour, counterDate.hour) || freq >= RRule$1.MINUTELY && notEmpty(byminute) && !includes(byminute, counterDate.minute) || freq >= RRule$1.SECONDLY && notEmpty(bysecond) && !includes(bysecond, counterDate.second)) {
	    return [];
	  }
	...
	//#region packages/@mantine/schedule/src/utils/expand-recurring-events/expand-recurring-events.ts
	const RRule = RRule$1;
	function getRecurrenceKey(recurringEventId, recurrenceId) {
		return `${recurringEventId}::${recurrenceId}`;
	}
	function overlapsRange(eventStart, eventEnd, rangeStart, rangeEnd) {
		return (eventEnd.isAfter(rangeStart) || eventEnd.isSame(rangeStart)) && (eventStart.isBefore(rangeEnd) || eventStart.isSame(rangeEnd));
	}
	function getExdateSet(recurrence) {
		if (!recurrence?.exdate) return /* @__PURE__ */ new Set();
		const values = recurrence.exdate.map((value) => dayjs(value)).filter((value) => value.isValid()).map((value) => value.format("YYYY-MM-DD HH:mm:ss"));
		return new Set(values);
	}
	function getRRuleString(rule) {
		const normalized = rule.trim();
		if (!normalized.includes("\n")) return normalized.startsWith("RRULE:") ? normalized.replace(/^RRULE:/, "") : normalized;
		const rruleLine = normalized.split("\n").map((line) => line.trim()).find((line) => line.startsWith("RRULE:"));
		return rruleLine ? rruleLine.replace(/^RRULE:/, "") : normalized;
	}
	function getOccurrenceStartsInRange(event, rangeStart, rangeEnd, expansionLimit, durationMs) {
		const dtstart = dayjs(event.recurrence?.dtstart || event.start);
		if (!dtstart.isValid() || !event.recurrence) return [];
		try {
			...
			return rule.between(searchStart, rangeEnd.toDate(), true).slice(0, expansionLimit).map((value) => dayjs(value));
		} catch {
			return [];
		}
	}
	...
	function createGeneratedInstance(event, occurrenceStart, durationMs) {
	...
	const DEFAULT_EXPANSION_LIMIT = 2e3;
	function expandRecurringEvents({ events, rangeStart, rangeEnd, expansionLimit = DEFAULT_EXPANSION_LIMIT }) {
		...
		const output = [];
		const consumedOverrideIds = /* @__PURE__ */ new Set();
		for (const event of regularEvents) if (isEventInRange(event, start, end)) output.push(validateEvent(event));
		for (const event of recurringEvents) {
			...
			for (const occurrenceStart of starts) {
				const recurrenceId = occurrenceStart.format("YYYY-MM-DD HH:mm:ss");
				if (exdate.has(recurrenceId)) continue;
				...
				if (overlapsRange(dayjs(generated.start), dayjs(generated.end), start, end)) output.push(validateEvent(generated));
			}
		}
		for (const override of overrides.values()) {
			if (consumedOverrideIds.has(override.id)) continue;
			if (isEventInRange(override, start, end)) output.push(validateEvent(override));
		}
		return output;
	}
	...
	function useDatesContext() {
		const ctx = reactExports.use(DatesProviderContext);
		const getLocale = reactExports.useCallback((input) => input || ctx.locale, [ctx.locale]);
		const getFirstDayOfWeek = reactExports.useCallback((input) => typeof input === "number" ? input : ctx.firstDayOfWeek, [ctx.firstDayOfWeek]);
		const getWeekendDays = reactExports.useCallback((input) => Array.isArray(input) ? input : ctx.weekendDays, [ctx.weekendDays]);
		const getLabelSeparator = reactExports.useCallback((input) => typeof input === "string" ? input : ctx.labelSeparator, [ctx.labelSeparator]);
		return {
			...ctx,
			getLocale,
			getFirstDayOfWeek,
	...
	//#region packages/@mantine/schedule/src/components/DragContext/DragContext.tsx
	const DragContext = reactExports.createContext({});

	//#region packages/@mantine/schedule/src/components/ScheduleEvent/ScheduleEvent.module.css
	var ScheduleEvent_module_default = {
		"event": "m_1ac94670",
		"eventInner": "m_71699dc6",
		"eventResizeHandle": "m_520128c"
	};

	//#region packages/@mantine/schedule/src/components/ScheduleEvent/ScheduleEvent.tsx
	const defaultProps$6 = {
		__staticSelector: "ScheduleEvent",
		mode: "default",
		radius: "sm"
	};
	const varsResolver$4 = createVarsResolver((theme, { event, variant, radius }) => {
	...
	const ScheduleEvent = factory((_props) => {
		const props = useProps("ScheduleEvent", defaultProps$6, _props);
		const { classNames, className, style, styles, unstyled, vars, attributes, children, nowrap, radius, color, __staticSelector, event, renderEventBody, renderEvent, size, autoSize, mod, hanging, draggable = false, onEventDragStart, onEventDragEnd, isDragging = false, mode, withResize = false, onResizeStart, isResizing = false, ...others } = props;
		const ctx = reactExports.use(DragContext);
		const getStyles = useStyles({
			name: __staticSelector,
			classes: ScheduleEvent_module_default,
			props,
			className,
			style,
			classNames,
		...
		const dragEndRef = reactExports.useRef(ctx.onDragEnd);
		...
		const eventChildren = /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
			showResizeHandles && /* @__PURE__ */ jsxRuntimeExports.jsx(Box, {
		...
		const rootProps = {
			...
			onDragStart: mode === "static" ? void 0 : handleDragStart,
			onDragEnd: mode === "static" ? void 0 : handleDragEnd,
			onClick: mode === "static" ? void 0 : others.onClick,
			...others,
			children: eventChildren
		};
		if (typeof renderEvent === "function") return renderEvent(event, rootProps);
		return /* @__PURE__ */ jsxRuntimeExports.jsx(UnstyledButton, { ...rootProps });
	});
	ScheduleEvent.displayName = "@mantine/schedule/ScheduleEvent";
	ScheduleEvent.classes = ScheduleEvent_module_default;
	ScheduleEvent.varsResolver = varsResolver$4;

	//#region packages/@mantine/schedule/src/components/MoreEvents/MoreEvents.module.css
	var MoreEvents_module_default = {
		"moreEventsButton": "m_c958249f",
		"moreEventsDropdown": "m_fc2b9a3e",
		"moreEventsList": "m_89f3254b"
	};

	//#region packages/@mantine/schedule/src/components/MoreEvents/MoreEvents.tsx
	const defaultProps$5 = { dropdownType: "popover" };
	const MoreEvents = factory((_props) => {
		const props = useProps("MoreEvents", defaultProps$5, _props);
		const { classNames, className, style, styles, unstyled, vars, attributes, radius, dropdownType, events, moreEventsCount, popoverProps, modalProps, onDropdownClose, children, modalTitle, renderEventBody, id, labels, mode, ...others } = props;
		const [dropdownOpened, dropdownHandlers] = useDisclosure();
		const getStyles = useStyles({
			name: "MoreEvents",
			classes: MoreEvents_module_default,
			props,
			className,
			style,
			classNames,
		...
		const eventsList = /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
			...getStyles("moreEventsList"),
			children: events.map((event) => /* @__PURE__ */ jsxRuntimeExports.jsx(ScheduleEvent, {
				radius,
				event,
				size: "md",
				renderEventBody,
		...
		return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [dropdownType === "modal" && /* @__PURE__ */ jsxRuntimeExports.jsx(Modal, {
			...
			...modalProps,
			children: eventsList
		}), /* @__PURE__ */ jsxRuntimeExports.jsxs(Popover, {
			...
			children: [/* @__PURE__ */ jsxRuntimeExports.jsx(Popover.Target, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(UnstyledButton, {
				...getStyles("moreEventsButton"),
				mod: { static: mode === "static" },
				onClick: () => dropdownHandlers.toggle(),
				...others,
				children: getLabel("moreLabel", labels)(moreEventsCount)
			}) }), /* @__PURE__ */ jsxRuntimeExports.jsx(Popover.Dropdown, {
				...getStyles("moreEventsDropdown"),
				children: eventsList
			})]
		})] });
	});
	MoreEvents.displayName = "@mantine/schedule/MoreEvents";
	MoreEvents.classes = MoreEvents_module_default;

	//#region packages/@mantine/schedule/src/components/ScheduleHeader/HeaderControl/HeaderControl.module.css
	var HeaderControl_module_default = { "headerControl": "m_b366a0f3" };

	//#region packages/@mantine/schedule/src/components/ScheduleHeader/HeaderControl/HeaderControl.tsx
	const defaultProps$4 = {
		__staticSelector: "HeaderControl",
		interactive: true
	};
	const varsResolver$3 = createVarsResolver((_theme, { radius }) => ({ headerControl: { "--control-radius": radius === void 0 ? void 0 : getRadius(radius) } }));
	const HeaderControl = factory((_props) => {
		const props = useProps("HeaderControl", defaultProps$4, _props);
		const { classNames, className, style, styles, unstyled, vars, __staticSelector, mod, attributes, active, square, radius, interactive, ...others } = props;
		return /* @__PURE__ */ jsxRuntimeExports.jsx(UnstyledButton, {
			...useStyles({
				name: __staticSelector,
				classes: HeaderControl_module_default,
				props,
				className,
				style,
				classNames,
			...
			})("headerControl", { active: interactive }),
			mod: [{
				active,
				square,
				interactive
	...
	HeaderControl.classes = HeaderControl_module_default;
	HeaderControl.varsResolver = varsResolver$3;
	function ScheduleHeaderNext(props) {
		const { dir } = useDirection();
		return /* @__PURE__ */ jsxRuntimeExports.jsx(HeaderControl, {
			"data-type": "next",
			"aria-label": getLabel("next", props.labels),
			square: true,
			...props,
			children: /* @__PURE__ */ jsxRuntimeExports.jsx(AccordionChevron, { style: { transform: `rotate(${dir === "rtl" ? 90 : -90}deg)` } })
		});
	}
	function ScheduleHeaderPrevious(props) {
		const { dir } = useDirection();
		return /* @__PURE__ */ jsxRuntimeExports.jsx(HeaderControl, {
			"data-type": "previous",
	...
	function ScheduleHeaderToday(props) {
		return /* @__PURE__ */ jsxRuntimeExports.jsx(HeaderControl, {
			"data-type": "today",
			"aria-label": getLabel("today", props.labels),
			...props,
			children: getLabel("today", props.labels)
		});
	}
	...
	//#region packages/@mantine/schedule/src/components/ScheduleHeader/MonthYearSelect/MonthYearSelect.module.css
	var MonthYearSelect_module_default = {
		"monthYearSelectTarget": "m_9d235876",
		"monthYearSelectList": "m_673e0cc3",
		"monthYearSelectDropdown": "m_e24605b6",
		"monthYearSelectLabel": "m_807fa76f",
		"monthYearSelectControl": "m_9baf5b18"
	};

	//#region packages/@mantine/schedule/src/components/ScheduleHeader/MonthYearSelect/MonthYearSelect.tsx
	const defaultProps$3 = {
		__staticSelector: "MonthYearSelect",
		withMonths: true
	};
	const varsResolver$2 = createVarsResolver((_theme, { radius }) => ({ monthYearSelectDropdown: { "--control-radius": radius === void 0 ? void 0 : getRadius(radius) } }));
	const MonthYearSelect = factory((_props) => {
		const props = useProps("MonthYearSelect", defaultProps$3, _props);
		const { __staticSelector, classNames, className, style, styles, unstyled, vars, attributes, popoverProps, startYear, endYear, onYearChange, onMonthChange, locale, monthsListFormat, monthValue, yearValue, labelFormat, radius, getMonthControlProps, getYearControlProps, withMonths, id, labels, ...others } = props;
		const getStyles = useStyles({
			name: __staticSelector,
			classes: MonthYearSelect_module_default,
			props,
			className,
			style,
			classNames,
		...
		const hasActiveYear = yearValue !== void 0 && yearValue >= _startYear && yearValue <= _endYear;
		...
		const months = withMonths ? getMonthsList({
		...
		return /* @__PURE__ */ jsxRuntimeExports.jsxs(Popover, {
			...
			shadow: "md",
			offset: 3,
			width: withMonths ? void 0 : "target",
			opened,
			onChange: handlers.set,
			id,
			...popoverProps,
			children: [/* @__PURE__ */ jsxRuntimeExports.jsx(Popover.Target, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(HeaderControl, {
				...getStyles("monthYearSelectTarget"),
				__staticSelector,
				radius,
				"data-with-months": withMonths || void 0,
			...
			}) }), /* @__PURE__ */ jsxRuntimeExports.jsxs(Popover.Dropdown, {
				"data-with-months": withMonths || void 0,
				...getStyles("monthYearSelectDropdown"),
				children: [withMonths && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
					"data-list": true,
					...getStyles("monthYearSelectList"),
					children: [/* @__PURE__ */ jsxRuntimeExports.jsx("div", {
						...getStyles("monthYearSelectLabel"),
						children: getLabel("month", labels)
					}), months]
				}), /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
					"data-list": true,
					...getStyles("monthYearSelectList"),
					children: [withMonths && /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
						...getStyles("monthYearSelectLabel"),
						children: getLabel("year", labels)
					}), years]
				})]
			})]
		});
	...
	MonthYearSelect.classes = MonthYearSelect_module_default;
	MonthYearSelect.varsResolver = varsResolver$2;

	//#region packages/@mantine/schedule/src/components/ScheduleHeader/ViewSelect/ViewSelect.module.css
	var ViewSelect_module_default = { "viewSelect": "m_e106e12d" };

	//#region packages/@mantine/schedule/src/components/ScheduleHeader/ViewSelect/ViewSelect.tsx
	...
	const ViewSelect = factory((_props) => {
		const props = useProps("ViewSelect", defaultProps$2, _props);
		const { classNames, className, style, styles, unstyled, vars, attributes, value, onChange, views, __staticSelector, radius, labels, ...others } = props;
		const getStyles = useStyles({
			name: __staticSelector,
			classes: ViewSelect_module_default,
			props,
			className,
			style,
			classNames,
		...
		const activatedWithKeyboardRef = reactExports.useRef(false);
		reactExports.useEffect(() => {
			if (activatedWithKeyboardRef.current && document.activeElement === document.body) {
				...
				if (selectedIndex !== -1) controlsRef.current[selectedIndex]?.focus();
			}
		...
		const handleKeyDown = (event, index) => {
			...
			} else if (event.key === "Enter" || event.key === " ") activatedWithKeyboardRef.current = true;
		};
		const switchToLabelKeys = {
			day: "switchToDayView",
		...
		const items = views.map((view, index) => {
			...
			return /* @__PURE__ */ jsxRuntimeExports.jsx(HeaderControl, {
				...
				radius,
				role: "tab",
				"aria-label": getLabel(switchToLabelKeys[view], labels),
				"aria-selected": isSelected,
				tabIndex: isSelected ? 0 : -1,
				children: getLabel(view, labels)
			}, view);
		});
		return /* @__PURE__ */ jsxRuntimeExports.jsx(Box, {
	...
	ViewSelect.classes = ViewSelect_module_default;

	//#region packages/@mantine/schedule/src/components/ScheduleHeader/ScheduleHeader.module.css
	var ScheduleHeader_module_default = {
		"header": "m_9d44fc56",
		"navigationGroup": "m_21150122",
		"todayControl": "m_7a42c1e5",
		"viewSelect": "m_5998194a",
		"compactViewSelect": "m_feecf21b"
	};

	//#region packages/@mantine/schedule/src/components/ScheduleHeader/ScheduleHeader.tsx
	const defaultProps$1 = { __staticSelector: "ScheduleHeader" };
	const varsResolver$1 = createVarsResolver(() => ({ scheduleHeader: { "--test": "test" } }));
	const ScheduleHeader = factory((_props) => {
		const props = useProps("ScheduleHeader", defaultProps$1, _props);
		const { classNames, className, style, styles, unstyled, vars, attributes, __staticSelector, ...others } = props;
		return /* @__PURE__ */ jsxRuntimeExports.jsx(Box, {
			...useStyles({
				name: __staticSelector,
				classes: ScheduleHeader_module_default,
				props,
				className,
				style,
				classNames,
	...
	ScheduleHeader.classes = ScheduleHeader_module_default;
	ScheduleHeader.varsResolver = varsResolver$1;
	...
	//#region packages/@mantine/schedule/src/hooks/use-drag-state.ts
	const initialState = {
		isDragging: false,
		draggedEventId: null,
		draggedEvent: null,
	...
	function useDragState() {
		...
		return {
			state,
			startDrag: reactExports.useCallback((event) => {
				setState({
					isDragging: true,
			...
			endDrag: reactExports.useCallback(() => {
				setState(initialState);
			}, []),
			setDropTarget: reactExports.useCallback((target) => {
				setState((prev) => ({
					...prev,
					dropTarget: target
				}));
			}, []),
			clearDropTarget: reactExports.useCallback(() => {
				setState((prev) => ({
					...prev,
					dropTarget: null
				}));
	...
	//#region packages/@mantine/schedule/src/hooks/use-drag-drop-handlers.ts
	/**
	...
	*/
	function useDragDropHandlers(options) {
		const { enabled, mode, onEventDrop, canDragEvent, onEventDragStart, onEventDragEnd, calculateDropTarget, onExternalDrop } = options;
		const stableOnEventDrop = reactExports.useEffectEvent(onEventDrop || (() => {}));
		const stableOnEventDragStart = reactExports.useEffectEvent(onEventDragStart || (() => {}));
		const stableOnEventDragEnd = reactExports.useEffectEvent(onEventDragEnd || (() => {}));
		const stableOnExternalDrop = reactExports.useEffectEvent(onExternalDrop || (() => {}));
		...
		const handleDragOver = reactExports.useCallback((event, target) => {
			...
			if (isInternalDrag && !enabled) return;
			if (!isInternalDrag && !onExternalDrop) return;
			event.preventDefault();
		...
		const handleDrop = reactExports.useCallback((event, target) => {
			event.preventDefault();
			const isInternalDrag = dragState.state.isDragging && event.dataTransfer.types.includes("application/json");
			...
			if (!isInternalDrag && onExternalDrop) {
				if (dragState.state.isDragging) handleDragEnd();
		...
		const isDraggableEvent = reactExports.useCallback((event) => {
			return enabled && mode !== "static" && event.display !== "background" && (canDragEvent ? canDragEvent(event) : true);
		}, [
			enabled,
			mode,
			canDragEvent
		]);
		const isDropTarget = reactExports.useCallback((target) => {
			if (dropTarget && typeof dropTarget === "object" && typeof target === "object") return JSON.stringify(dropTarget) === JSON.stringify(target);
	...
	//#region packages/@mantine/schedule/src/hooks/use-slot-drag-select.ts
	function useSlotDragSelect({ enabled = true, onDragEnd }) {
		const [selectedRange, setSelectedRange] = reactExports.useState(null);
		const dragRef = reactExports.useRef(null);
		const stableOnDragEnd = reactExports.useEffectEvent(onDragEnd || (() => {}));
		const handleSlotPointerDown = reactExports.useCallback((_event, index, group) => {
			if (!enabled) return;
			dragRef.current = {
				group,
				startIndex: index,
		...
		reactExports.useEffect(() => {
			...
			const handlePointerMove = (e) => {
				...
				for (const el of elements) {
					const indexAttr = el.getAttribute?.("data-drag-slot-index");
					const groupAttr = el.getAttribute?.("data-drag-slot-group");
			...
			const handlePointerUp = () => {
				if (dragRef.current) {
					...
					if (startIndex !== currentIndex) stableOnDragEnd(Math.min(startIndex, currentIndex), Math.max(startIndex, currentIndex), group);
				}
		...
		return {
			...
			isSlotSelected: reactExports.useCallback((index, group) => {
				if (!selectedRange || selectedRange.group !== group) return false;
	...
	//#region packages/@mantine/schedule/src/components/ScheduleHeader/ScheduleHeaderBase.tsx
	const VIEW_LEVELS = [
		"day",
		"week",
		"month",
	...
	function ScheduleHeaderBase({ view, navigationHandlers, control, labels, onDateChange, onViewChange, previousControlProps, nextControlProps, todayControlProps, viewSelectProps, stylesApiProps }) {
		const centralControl = control.monthYearSelect ? /* @__PURE__ */ jsxRuntimeExports.jsx(ScheduleHeader.MonthYearSelect, {
			...stylesApiProps,
			labels,
			...control.monthYearSelect
		}) : /* @__PURE__ */ jsxRuntimeExports.jsx(ScheduleHeader.Control, {
			...stylesApiProps,
			interactive: false,
			miw: control.miw,
			children: control.title
		});
		const compactViewSelectData = (viewSelectProps?.views || VIEW_LEVELS).map((v) => ({
			value: v,
			label: getLabel(v, labels)
		}));
		return /* @__PURE__ */ jsxRuntimeExports.jsxs(ScheduleHeader, {
			...stylesApiProps,
			children: [
				/* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
					className: ScheduleHeader_module_default.navigationGroup,
					children: [
						/* @__PURE__ */ jsxRuntimeExports.jsx(ScheduleHeader.Previous, {
							...stylesApiProps,
						...
						centralControl,
						/* @__PURE__ */ jsxRuntimeExports.jsx(ScheduleHeader.Next, {
							...stylesApiProps,
				...
				/* @__PURE__ */ jsxRuntimeExports.jsx("div", {
					className: ScheduleHeader_module_default.todayControl,
					children: /* @__PURE__ */ jsxRuntimeExports.jsx(ScheduleHeader.Today, {
						...stylesApiProps,
				...
				/* @__PURE__ */ jsxRuntimeExports.jsx(NativeSelect, {
					className: ScheduleHeader_module_default.compactViewSelect,
				...
				/* @__PURE__ */ jsxRuntimeExports.jsx("div", {
					className: ScheduleHeader_module_default.viewSelect,
					style: { marginInlineStart: "auto" },
					children: /* @__PURE__ */ jsxRuntimeExports.jsx(ScheduleHeader.ViewSelect, {
						value: view,
	...
	//#region packages/@mantine/schedule/src/components/MonthView/handle-month-view-key-down.ts
	...
	function getNextPosition({ direction, weekIndex, dayIndex, size }) {
		const currentWeekSize = size[weekIndex];
		if (!currentWeekSize) return null;
		switch (direction) {
			case "up": {
			...
			case "down": {
				if (weekIndex === size.length - 1) return null;
	...
	function focusOnNextFocusableControl({ controlsRef, direction, weekIndex, dayIndex, size }) {
		...
		if (controlToFocus.disabled || controlToFocus.getAttribute("data-hidden") || controlToFocus.getAttribute("data-day-placeholder")) focusOnNextFocusableControl({
			controlsRef,
			direction,
	...
	function handleMonthViewKeyDown({ controlsRef, weekIndex, dayIndex, event }) {
	...
	//#region packages/@mantine/schedule/src/components/MonthView/get-month-view-events/add-event-to-day-groups.ts
	function addEventToDayGroups({ positionedEvent, eventStart, eventEnd, groupedByDay, eventsAddedToDay, weekIdx }) {
		if (weekIdx === 0 || !eventsAddedToDay.has(positionedEvent.id.toString())) {
			...
			while (dayDate.isBefore(eventEnd) || dayDate.isSame(eventEnd, "day")) {
				...
				if (groupedByDay[dayDateStr]) groupedByDay[dayDateStr].push(positionedEvent);
	...
	//#region packages/@mantine/schedule/src/components/MonthView/get-month-view-events/calculate-event-position-in-week.ts
	function calculateEventPositionInWeek({ eventStart, eventEnd, weekStart, weekEnd, isMultiday }) {
		...
		const hanging = hangingStart && hangingEnd ? "both" : hangingStart ? "start" : hangingEnd ? "end" : "none";
		if (displayStart.isBefore(weekStart)) displayStart = weekStart;
		if (displayEnd.isAfter(weekEnd)) displayEnd = weekEnd;
	...
	//#region packages/@mantine/schedule/src/components/MonthView/get-month-view-events/find-available-row.ts
	function findAvailableRow({ existingEvents, startDayIndex, daysSpanned, weekStart }) {
		let row = 0;
		for (const existing of existingEvents) {
			const existingStart = dayjs(existing.start).startOf("day");
			const existingDayIndex = (existingStart.isBefore(weekStart) || existingStart.isSame(weekStart, "day") ? weekStart : existingStart).diff(weekStart, "day");
			if (existingDayIndex + (existing.position?.width || 0) / 100 * 7 > startDayIndex && existingDayIndex < startDayIndex + daysSpanned) row = Math.max(row, (existing.position?.row || 0) + 1);
		}
		return row;
	}

	//#region packages/@mantine/schedule/src/components/MonthView/get-month-view-events/get-weeks-in-range.ts
	function getWeeksInRange({ rangeStart, rangeEnd, firstDayOfWeek }) {
		const weeks = [];
		const groupedByDay = {};
		let currentDate = dayjs(getStartOfWeek({
	...
	//#region packages/@mantine/schedule/src/components/MonthView/get-month-view-events/get-month-positioned-events.ts
	function getMonthPositionedEvents({ date, events, firstDayOfWeek = 1, range }) {
		const groupedByWeek = {};
		const backgroundByWeek = {};
		const eventsAddedToDay = /* @__PURE__ */ new Set();
		const { weeks, groupedByDay } = getWeeksInRange({
			rangeStart: range ? dayjs(range.start) : dayjs(date).startOf("month"),
			rangeEnd: range ? dayjs(range.end) : dayjs(date).startOf("month").endOf("month"),
			firstDayOfWeek
		});
		...
		for (const event of events) {
			...
			const eventEnd = rawEnd.hour() === 0 && rawEnd.minute() === 0 && rawEnd.second() === 0 ? rawEnd.startOf("day").subtract(1, "day") : rawEnd.startOf("day");
			...
			for (let weekIdx = 0; weekIdx < weeks.length; weekIdx++) {
				...
				if ((eventStart.isBefore(weekEnd) || eventStart.isSame(weekEnd, "day")) && (eventEnd.isAfter(weekStart) || eventEnd.isSame(weekStart, "day"))) {
					const { startDayIndex, daysSpanned, startOffset, width, hanging } = calculateEventPositionInWeek({
						eventStart,
						eventEnd,
						weekStart,
						weekEnd,
	...
	//#region packages/@mantine/schedule/src/components/MonthView/get-month-view-events/get-month-view-events.ts
	function getMonthViewEvents({ date, events, firstDayOfWeek = 1, withOutsideDays, consistentWeeks }) {
		...
		for (const event of events) if (dayjs(event.end).isAfter(range.start, "day") || dayjs(event.start).isBefore(range.end, "day")) {
			filteredEvents.push(validateEvent(event));
			if (!ids.has(event.id)) ids.add(event.id);
			else throw new Error(`[@mantine/schedule] MonthView: Duplicated event ids found: ${event.id}`);
		}
	...
	//#region packages/@mantine/schedule/src/components/MonthView/MonthView.module.css
	var MonthView_module_default = {
		"monthView": "m_8eceba9d",
		"monthViewWeekdays": "m_6634a808",
		"monthViewWeek": "m_bdaf3831",
		"monthViewWeekNumber": "m_873456da",
		"monthViewWeekday": "m_c97d91cb",
		"monthViewWeekdaysCorner": "m_25eee07d",
		"monthViewDay": "m_ab476fbf",
		"monthViewDayLabel": "m_fd501e75",
		"monthViewBackgroundEvent": "m_9e8509af",
		"monthViewEvents": "m_f0fa5e16"
	};

	//#region packages/@mantine/schedule/src/components/MonthView/MonthView.tsx
	const varsResolver = createVarsResolver((_theme, { radius, maxEventsPerDay }) => ({ monthView: {
		"--month-view-radius": radius !== void 0 ? getRadius(radius) : void 0,
		"--month-view-max-events": maxEventsPerDay !== void 0 ? `${Math.min(10, Math.max(1, maxEventsPerDay))}` : void 0
	} }));
	const defaultProps = {
	...
	const MonthView = factory((_props) => {
		const props = useProps("MonthView", defaultProps, _props);
		const { classNames, className, style, styles, unstyled, attributes, vars, mod, date, onDateChange, withWeekNumbers, withWeekDays, locale, weekdayFormat, firstDayOfWeek, weekendDays, __staticSelector, getDayProps, getWeekNumberProps, onDayClick, onWeekNumberClick, consistentWeeks, highlightToday, radius, withOutsideDays, withHeader, monthYearSelectProps, onViewChange, todayControlProps, nextControlProps, previousControlProps, viewSelectProps, events, moreEventsProps, renderEventBody, renderEvent, withEventsDragAndDrop, onEventDrop, canDragEvent, onEventDragStart, onEventDragEnd, onEventClick, withDragSlotSelect, onSlotDragEnd, labels, mode, scrollAreaProps, onExternalEventDrop, recurrenceExpansionLimit, maxEventsPerDay: _maxEventsPerDay, ...others } = props;
		const maxEventsPerDay = Math.min(10, Math.max(1, _maxEventsPerDay ?? 2));
		const getStyles = useStyles({
			name: __staticSelector,
			classes: MonthView_module_default,
			props,
			className,
			style,
			classNames,
		...
		const handleExternalDrop = reactExports.useCallback((e, day) => {
		...
		const dragDrop = useDragDropHandlers({
			...
			onEventDragStart,
			onEventDragEnd,
			calculateDropTarget: (targetDay, draggedEvent) => {
				return calculateMonthDropDate({
					draggedEvent,
					targetDay
				});
			},
			onExternalDrop: onExternalEventDrop ? handleExternalDrop : void 0
		});
		const withDragHandlers = (withEventsDragAndDrop || !!onExternalEventDrop) && mode !== "static";
		const flatDaysRef = reactExports.useRef([]);
		const slotDragSelect = useSlotDragSelect({
			...
			onDragEnd: (startIndex, endIndex) => {
				...
				if (startDay && endDay) onSlotDragEnd(dayjs(startDay).startOf("day").format("YYYY-MM-DD HH:mm:ss"), dayjs(endDay).endOf("day").format("YYYY-MM-DD HH:mm:ss"));
			}
		});
		const daysRef = reactExports.useRef([]);
		const monthDays = getMonthDays$1({
		...
		const firstDayIndex = (() => {
			for (let weekIndex = 0; weekIndex < monthDays.length; weekIndex++) {
				...
				for (let dayIndex = 0; dayIndex < week.length; dayIndex++) {
					...
					if (!!isSameMonth(date, day) || withOutsideDays) return {
						weekIndex,
						dayIndex
					};
				}
		...
		const weekdays = withWeekDays ? getWeekdaysNames({
			locale: ctx.getLocale(locale),
			format: weekdayFormat,
			firstDayOfWeek: ctx.getFirstDayOfWeek(firstDayOfWeek)
		}).map((day, index) => /* @__PURE__ */ reactExports.createElement("div", {
			...getStyles("monthViewWeekday"),
			key: index
		}, day)) : null;
		const monthGroup = "month";
		flatDaysRef.current = monthDays.flat();
		const weeks = monthDays.map((week, weekIndex) => {
			if (!daysRef.current[weekIndex]) daysRef.current[weekIndex] = [];
			const days = week.map((day, dayIndex) => {
				...
				const ariaLabel = dayjs(day).locale(locale || ctx.locale).format("MMMM D, YYYY");
				const dayProps = getDayProps?.(dayjs(day).format("YYYY-MM-DD")) || {};
				const today = dayjs(day).isSame(dayjs(), "day") && highlightToday;
				if (outside && !withOutsideDays) return /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
					"data-static": true,
					...getStyles("monthViewDay", { style: dayProps.style })
				}, day);
				const isFirstDay = weekIndex === firstDayIndex.weekIndex && dayIndex === firstDayIndex.dayIndex;
				...
				return /* @__PURE__ */ reactExports.createElement(UnstyledButton, {
					"aria-label": ariaLabel,
					...dayProps,
					...getStyles("monthViewDay", {
					...
					"data-drag-slot-index": withDragSlotSelect && mode !== "static" ? flatIndex : void 0,
					"data-drag-slot-group": withDragSlotSelect && mode !== "static" ? monthGroup : void 0,
					onClick: mode === "static" ? void 0 : (event) => {
						onDayClick?.(dayjs(day).format("YYYY-MM-DD"), event);
						dayProps.onClick?.(event);
					},
					onPointerDown: withDragSlotSelect && mode !== "static" ? (e) => slotDragSelect.handleSlotPointerDown(e, flatIndex, monthGroup) : void 0,
					onKeyDown: (event) => {
					...
					onDragOver: withDragHandlers ? (e) => dragDrop.handleDragOver(e, day) : void 0,
					onDragLeave: withDragHandlers ? dragDrop.handleDragLeave : void 0,
					onDrop: withDragHandlers ? (e) => dragDrop.handleDrop(e, day) : void 0
				}, /* @__PURE__ */ jsxRuntimeExports.jsx("span", {
					"data-today": today || void 0,
					...getStyles("monthViewDayLabel"),
					children: dayjs(day).format("D")
				}));
			});
			...
			const backgroundEventNodes = (monthEvents.backgroundByWeek[weekIndex] || []).map((event) => {
				...
				const bgEventBody = typeof renderEventBody === "function" ? renderEventBody(event) : event.title;
				const bgEventProps = {
					key: `bg-${event.id}-${weekIndex}`,
					...getStyles("monthViewBackgroundEvent", { style: {
				...
				if (typeof renderEvent === "function") return renderEvent(event, bgEventProps);
				const { key: bgEventKey, ...restBgEventProps } = bgEventProps;
				return /* @__PURE__ */ jsxRuntimeExports.jsx(Box, { ...restBgEventProps }, bgEventKey);
			});
			const rowHeightPercent = 100 / maxEventsPerDay;
			const events = (monthEvents.groupedByWeek[weekIndex] || []).filter((event) => event.position.row < maxEventsPerDay).map((event) => {
				const isDraggable = dragDrop.isDraggableEvent(event);
				return /* @__PURE__ */ jsxRuntimeExports.jsx(ScheduleEvent, {
					event,
					nowrap: true,
					autoSize: true,
					...
					radius,
					mode,
					onClick: onEventClick ? (e) => onEventClick(event, e) : void 0,
					style: {
						position: "absolute",
			...
			const moreEventsNodes = week.map((day, dayIndex) => {
				...
				if (hiddenEventsCount <= 0) return null;
				return /* @__PURE__ */ jsxRuntimeExports.jsx(MoreEvents, {
					events: dayEvents,
			...
			return /* @__PURE__ */ reactExports.createElement("div", {
				...getStyles("monthViewWeek"),
				key: weekIndex
			}, withWeekNumbers && /* @__PURE__ */ jsxRuntimeExports.jsx(UnstyledButton, {
				...
				children: weekNumber
			}, weekNumber), /* @__PURE__ */ reactExports.createElement("div", {
				...getStyles("monthViewEvents"),
				key: "week-events"
			}, backgroundEventNodes, events, moreEventsNodes), days);
		});
		const content = /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, {
			mod: [{
			...
			...getStyles("monthView"),
			...others,
			children: [withHeader && /* @__PURE__ */ jsxRuntimeExports.jsx(ScheduleHeaderBase, {
				view: "month",
				navigationHandlers: {
				...
				control: { monthYearSelect: {
					...
					onYearChange: (year) => onDateChange?.(toDateString(dayjs(date).set("year", year).startOf("month"))),
					onMonthChange: (month) => onDateChange?.(toDateString(dayjs(date).set("month", month).startOf("month"))),
				...
				children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
					...getStyles("monthViewInner"),
					children: [weekdays && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
						...getStyles("monthViewWeekdays"),
						children: [withWeekNumbers && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { ...getStyles("monthViewWeekdaysCorner") }), weekdays]
					}), weeks]
				})
			})]
		});
		if (withEventsDragAndDrop) return /* @__PURE__ */ jsxRuntimeExports.jsx(DragContext.Provider, {
			value: dragDrop.dragContextValue,
			children: content
		});
		return content;
	});
	MonthView.displayName = "@mantine/schedule/MonthView";
	MonthView.classes = MonthView_module_default;
	...
	const eventStore = createStore((set) => ({
	    events: [],
	}));
	...
	const Calendar = () => {
	    ...
	    return (jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [jsxRuntimeExports.jsxs(ScheduleHeader, { styles: { header: { justifyContent: 'center' } }, children: [jsxRuntimeExports.jsx(ScheduleHeader.Previous, { onClick: () => setDate(dayjs(date)
	                            .subtract(1, 'month')
	                            .startOf('month')
	                            .format('YYYY-MM-DD')) }), jsxRuntimeExports.jsx(ScheduleHeader.MonthYearSelect, { yearValue: dayjs(date).year(), monthValue: dayjs(date).month(), onYearChange: (year) => setDate(dayjs(date)
	                            .year(year)
	                            .startOf('month')
	                            .format('YYYY-MM-DD')), onMonthChange: (month) => setDate(dayjs(date)
	                            .month(month)
	                            .startOf('month')
	...
	const CalendarWrapper = () => {
	    return (jsxRuntimeExports.jsx(MantineProvider, { theme: theme, defaultColorScheme: 'dark', children: jsxRuntimeExports.jsx(Calendar, {}) }));
	};
